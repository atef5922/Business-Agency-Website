...
export const metadata: Metadata = {
  title: "Team",
  description: "Meet the Multitech Solution team behind consulting, automation, software architecture, and project delivery."
};
    ...
    <main>
      ...
      <section className="bg-white py-16 sm:py-20 lg:py-24">
        <Container className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <Image src="https://images.unsplash.com/photo-1556761175-4b46a572b786?auto=format&fit=crop&w=1100&q=80" alt="Multitech Solution collaborative culture" width={900} height={650} className="rounded-3xl object-cover" />
